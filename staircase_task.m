...
Filename = ['M:\Experiments\OrientationWheel\Orient_Data\Staircasing\' part_num '_staircase.mat'];
% -------------------------------------------------------------------------    
...
prefs.lags = [2,prefs.rate/2:prefs.rate/2:prefs.rate*2]; %lag*8.333 = time ms
